import { API_VERSIONS, API_VERSION_HEADER_NAME } from '@supabase/auth-js/src/lib/constants'
import { expiresAt, looksLikeFetchResponse, parseResponseAPIVersion } from '@supabase/auth-js/src/lib/helpers'
import {
  AuthResponse,
