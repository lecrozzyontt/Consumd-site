...
import type {
  ...
  HeartbeatCallback,
  Timer,
} from '@supabase/realtime-js/src/phoenix/types'
import { CONNECTION_STATE, ConnectionState } from '@supabase/realtime-js/src/lib/constants'
import type { HeartbeatTimer, WebSocketLikeConstructor } from '@supabase/realtime-js/src/RealtimeClient'
