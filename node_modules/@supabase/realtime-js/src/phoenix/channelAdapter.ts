...
import { CHANNEL_STATES, MAX_PUSH_BUFFER_SIZE } from '@supabase/realtime-js/src/lib/constants'
import type { RealtimeChannelOptions } from '@supabase/realtime-js/src/RealtimeChannel'
import SocketAdapter from '@supabase/realtime-js/src/phoenix/socketAdapter'
import type {
